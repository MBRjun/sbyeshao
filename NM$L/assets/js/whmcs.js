...
function extraTicketAttachment() {
  jQuery("#fileuploads").append('<div class="input-group"><span class="input-group-btn"><span class="btn btn-default btn-sm btn-file"><span class="glyphicon glyphicon-folder-open"></span> <input type="file" name="attachments[]" multiple=""></span></span><input type="text" class="form-control input-sm" readonly=""></div>');
...
function rating_select(tid,c,id){
  window.location='http://subest.5awo.com/templates/123/assets/js/viewticket.php?tid='+tid+'&c='+c+'&rating='+id;
}
// Sidebar
// ===============================
